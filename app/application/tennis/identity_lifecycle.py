...
def append_tennis_identity_alias(
    *,
...
def append_tennis_identity_rename(
    *,
    ledger: SQLiteCanonicalIdentityLifecycleLedger,
    canonical_id: str,
    entity_type: str,
...
def append_tennis_identity_supersession(
    *,
    ledger: SQLiteCanonicalIdentityLifecycleLedger,
    canonical_id: str,
...
def append_tennis_temporal_provider_binding(
    *,
...
def remap_tennis_provider_identity(
    *,
    ledger: SQLiteTemporalProviderIdentityLedger,
    entity_type: str,
    provider_key: str,
